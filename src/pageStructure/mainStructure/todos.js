...
function todoDom() {
	...
	const titleD = new DomMaker('div', 'title', '', '', 'Title: Finish To Do');
	const title = titleD.maker();
	todo_1.appendChild(title); // appending the title


	const priorityD = new DomMaker('div', 'priority', '', '', 'Priority: High');
	...
	const time_countD = new DomMaker('div', 'time_count', '', '', 'Remain: 19-12-2022');
	...
	const start_dateD = new DomMaker('div', 'start_date', '', '', 'Start-at: 30-11-2022');
